        ...
        <div className="intro__left">
          <div className="intro__social">
            <ul className="intro__social-list">
              ...
              <li className="intro__social-item">
                <a href="https://www.linkedin.com/in/s%C6%A1n-%C4%91%E1%BA%B7ng-tu%E1%BA%A5n-292572240/" aria-label="Linkedin" target="_blank" rel="noreferrer" className="intro__social-icon">
