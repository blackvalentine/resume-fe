...
function Intro(props) {
  return (
    <div className="intro section-component" id="intro">
      <div className="intro__container container">
        <p className="intro__small-heading">Hi, my name is</p>
        <h2 className="intro__big-heading">Black Valentine</h2>
        <h3 className="intro__big-heading">I build things for the web.</h3>
        ...
        <button className="intro__button">Checkout my course!</button>
        ...
        <div className="intro__left">
          <div className="intro__social">
            <ul className="intro__social-list">
              ...
              <li className="intro__social-item">
                <a href="#123" aria-label="Twitter" target="_blank" rel="noreferrer" className="intro__social-icon">
              ...
              <li className="intro__social-item">
                <a href="#123" aria-label="Linkedin" target="_blank" rel="noreferrer" className="intro__social-icon">
              ...
              <li className="intro__social-item">
                <a href="#123" aria-label="Codepen" target="_blank" rel="noreferrer" className="intro__social-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-codepen"><title>CodePen</title><polygon points="12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5 12 2"></polygon><line x1="12" y1="22" x2="12" y2="15.5"></line><polyline points="22 8.5 12 15.5 2 8.5"></polyline><polyline points="2 15.5 12 8.5 22 15.5"></polyline><line x1="12" y1="2" x2="12" y2="8.5"></line></svg>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="intro__right">
          <div className="intro__gmail">
            <a href="tuanson.dang1404@gmail.com">tuanson.dang1404@gmail.com</a>
          </div>
        </div>
      </div>
    </div>
